    ...
    <footer className="border-t">
      <div className="container flex flex-col gap-8 py-8 md:flex-row md:py-12">
        <div className="flex-1 space-y-4">
          <h2 className="font-bold">Sketchy</h2>
          <p className="text-sm text-muted-foreground">Transforming sketches into stunning images with AI.</p>
        </div>
        <div className="grid flex-1 grid-cols-2 gap-12 sm:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link
                href="https://github.com/Greekatz"
              ...
              <Link
                href="https://www.linkedin.com/in/hungarbeit1912/"
                className="text-muted-foreground transition-colors hover:text-primary"
              >
      ...
      <div className="container border-t py-6">
        <p className="text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} HCMIU-CSE, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  )
